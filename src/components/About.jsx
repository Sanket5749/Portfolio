...
export default function About() {
  return (
    <div className="min-h-screen flex flex-col justify-center items-center bg-dark text-center px-4 py-12 space-y-12">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center mt-6 space-y-12 md:space-y-0 md:space-x-16">
        <div className="text-white text-center md:text-left max-w-2xl">
          ...
          <p className="text-xl leading-relaxed text-gray-300">
            ...
            BTech (2nd Year), I’m driven by a deep curiosity for technology
